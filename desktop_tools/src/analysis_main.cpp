...
UnivibeParams preset_params(const std::string& name) {
    ...
    if (name == "classic") {
        ...
        p.pre_hpf_hz = 20.0f;
        p.tone_tilt = -0.16f;
        p.sat_asymmetry = 0.045f;
        p.sat_out_trim = 0.94f;
        ...
        p.pre_hpf_hz = 24.0f;
        p.tone_tilt = -0.20f;
        p.sat_asymmetry = 0.075f;
        p.sat_out_trim = 0.88f;
    } else if (name == "trower") {
        ...
        p.pre_hpf_hz = 18.0f;
        p.tone_tilt = 0.06f;
        p.sat_asymmetry = 0.04f;
        p.sat_out_trim = 0.82f;
